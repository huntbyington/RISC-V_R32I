...
class spike_simple(pluginTemplate):
    ...
    def initialise(self, suite, work_dir, compliance_env):
        ...
        # but this target has no C extension, so Spike (and the DUT) decode
        # it as illegal and trap into an endless loop at mtvec=0 instead of
        # ever reaching the test's actual halt sequence.
